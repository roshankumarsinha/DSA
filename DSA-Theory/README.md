...
int divide = x >> 1;    // Equivalent to 4 / 2^1 = 2
        ...
        <h1>Heap :-</h1>
        <li>A Heap is a binary tree-based data structure that satisfies the heap property.</li>
        <li>
            Heap Properties:
            <ul>
                <li><b>Complete Binary Tree: </b> All levels are fully filled except possibly the last, and it's filled from left to right.</li>
                <li>
                    <b>Max Heap: </b> Parent nodes are greater than or equal to their children. The maximum element is at the root.
                    <pre>
                        <code>
                            10
                           /  \
                ...
                <li>
                    <b>Min Heap: </b> Parent nodes are less than or equal to their children. The minimum element is at the root.
                    <pre>
                        <code>
                            1
                           / \
        ...
        <li>Heaps are usually stored in arrays, not in tree/pointers</li>
        <li>
            For any node at index i: (if 0-based indexing is used)
            <ul>
        ...
        <li>
            For any node at index i: (if 1-based indexing is used)
            <ul>
                <li>Left Child: 2*i</li>
                <li>Right Child: 2*i + 1</li>
                <li>Parent: i / 2</li>
            </ul>
        </li>
        <li>
            <ul>
                ...
                <li>Accessing the root element: O(1)</li>
            </ul>
        </li>
        <li>Heapify is used to maintain the heap property after insertion or deletion.</li>
        <li>
            For a complete binary tree:
            <ul>
                <li>For 0-based indexing: Leaf nodes are at index n/2 to n-1</li>
                <li>For 1-based indexing: Leaf nodes are at index n/2 + 1 to n</li>
            </ul>
        </li>
        <li>
            ...
            <pre>
                <code>
                    ...
                    pq.push(2);    // Add 2 in heap
                    pq.push(3);    // Add 3 in heap
                    cout << pq.top();    // This will print 1
                </code>
            </pre>
        </li>
        <h1>Trie :-</h1>
        <li>A Trie is a tree-based data structure used to efficiently store and retrieve keys in a dataset of strings. It is particularly effective when dealing with prefix-based searches, like autocomplete or dictionary word searches.</li>
        <li>
            <ul>
                Key points about Trie:
                <li>Each node in a Trie represents a character of a string.</li>
                <li>The root node is empty, and each path from the root to a leaf node represents a word.</li>
                <li>Each node can have multiple children, representing different characters.</li>
                <li>Tries are often used for tasks like autocomplete, spell checking, search engines and IP routing.</li>
            </ul>
        </li>
        <li>
            <ul>
        ...
        <b>Properties of Trie:</b>
            <table>
                ...
                <tr>
                    <td>Nodes</td>
                    <td>Each node represents a character in a string.</td>
                </tr>
                <tr>
                    <td>Root</td>
                    <td>The starting point of the Trie (doesn’t hold a character itself).</td>
                </tr>
                <tr>
                    <td>Children</td>
                    <td>An array/map of references to child nodes for each possible character.</td>
                </tr>
                <tr>
                    <td>isEndOfWord</td>
                    <td>A flag at each node marking whether a complete word ends at that node.</td>
                </tr>
            </table>
        </li>
        <li>
            You can find notes on Trie in C++ here: <a href="https://takeuforward.org/data-structure/implement-trie-1/">Trie in C++</a>
        </li>
        <li>
            You can find custom notes using chatgpt here: <a href="https://chatgpt.com/share/6863d9ca-db2c-8006-9100-10cb0f692d74">Trie Implementation in C++</a>
        </li>
        <h1>Graph :-</h1>
