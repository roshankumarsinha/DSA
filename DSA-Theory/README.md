...
int divide = x >> 1;    // Equivalent to 4 / 2^1 = 2
        ...
        <li>
            ...
            Property	        Description
              Nodes	        Each node represents a character in a string.
              Root	        The starting point of the Trie (doesn’t hold a character itself).
              Children	    An array/map of references to child nodes for each possible character.
              isEndOfWord	A flag at each node marking whether a complete word ends at that node.
        </li>